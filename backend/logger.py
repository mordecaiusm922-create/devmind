...
def log_analysis(
    ...
    try:
        ...
        payload = {
           ...
           "complexity_score": float((evaluation.get("evaluation") or evaluation).get("specificity_score", 0) if isinstance(evaluation, dict) else evaluation.specificity_score),
"risk_score": float((evaluation.get("evaluation") or evaluation).get("confidence_score", 0) if isinstance(evaluation, dict) else evaluation.confidence_score),
